...
Public Class CarEdit
    ...
    Private Sub CarEdit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveCarData()
        If TextDailyAmount.Text = "" Then TextDailyAmount.EditValue = 0
        Try
            If TextSearchCarID.Text = -1 Then
                Dim con As SqlConnection
                Dim cmd As SqlCommand
                con = New SqlConnection(My.Settings.TrueTimeConnectionString)
                Dim SqlInsert As String = "Insert into CarsRent(CARNO,ChassiNoCar,CarType,CarModel,CarImage,             
                                        [active],YearCar,FuelsCar,MaintenanceAccountNo,AssetsAccountNo,
                                        RelatedService,CarCostCenter,CarDetails,Engine,ColorCar,DailyAmount,OwnByReferance) values( 
                                        '" & TextCARNO.Text & "',
                                        ...
                                        '" & Engine.Text & "',
                                        '" & SearchColor.EditValue & "',
                                        '" & TextDailyAmount.EditValue & "',
                                        '" & Referance.EditValue & "')"
            ...
            Else
                ...
                cmd = New SqlCommand("Update [dbo].[CarsRent] set
                                              CARNO='" & TextCARNO.Text & "', ChassiNoCar='" & TextChassiNoCar.Text & "',
                                              ...
                                              OwnByReferance='" & Referance.EditValue & "',
                                              Engine='" & Engine.EditValue & "',
                                              [active]= " & CheckActive.CheckState & ",
                                              ColorCar='" & SearchColor.EditValue & "',
                                              DailyAmount=" & TextDailyAmount.EditValue & ",
    ...
    Private Sub GetCarTypes()
        ...
        End Try
    End Sub
    Private Sub GetCarsColors()
        Try
            Dim Sql As New SQLControl
            Dim SqlString As String
            SqlString = " Select ID,ColorName from[dbo].[ItemsColors]"
            Sql.SqlTrueAccountingRunQuery(SqlString)
            SearchColor.Properties.DataSource = Sql.SQLDS.Tables(0)
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub Showdata()
        ...
        SQlString = " Select [CarID],[CARNO],[ChassiNoCar],[CarType],CarModel,YearCar,FuelsCar,
                             [active],[Rented],[CarImage],MaintenanceAccountNo,
                             AssetsAccountNo,RelatedService,CarCostCenter,[CarDetails],OwnByReferance,Engine,ColorCar,DailyAmount
                      From [dbo].[CarsRent] where CarID= " & Me.TextSearchCarID.Text
        Sql.SqlTrueAccountingRunQuery(SQlString)
        ...
        If Not IsDBNull(Sql.SQLDS.Tables(0).Rows(0).Item("ColorCar")) Then SearchColor.EditValue = Sql.SQLDS.Tables(0).Rows(0).Item("ColorCar")
    ...
    End Sub
    Dim Con As SqlConnection
    Dim InsuranceAdapter, TarkhesAdapter, AccidantAdapter As SqlDataAdapter
    Dim DS As DataSet
    ...
    Private Sub SearchLookUpEdit1_Properties_AddNewValue(sender As Object, e As DevExpress.XtraEditors.Controls.AddNewValueEventArgs) Handles SearchColor.Properties.AddNewValue
    ...
    Private Sub CarEdit_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Me.Dispose()
    End Sub
End Class