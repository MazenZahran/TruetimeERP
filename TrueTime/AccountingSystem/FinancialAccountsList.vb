...
Public Class FinancialAccountsList
    ...
    Private Sub FinancialAccountsList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
F.[FinancialStatment],F.[FinancialSector],
F.[AccType],F.[FatherAccount] as ParentID,
Case When F.[IsActive]=1 Then 'True' else 'False' end As IsActive ,C.[Code] As CurrencyName,
...
Left Join [dbo].[Currency] C on C.[CurrID]=F.Currency Order By F.[AccNo] "
    ...
    Private Sub InsertNewAccount()
        ...
        With F
            ...
            If _Account.GetAccountData(_AccountNo) = True Then
                ...
                .CheckNeedCostCenter.EditValue = _Account.NeedCostCenter
    ...
    Private Sub EditAccount()
        ...
        With F
            ...
            If _Account.GetAccountData(_AccountNo) = True Then
                ...
                .CheckNeedCostCenter.Checked = _Account.NeedCostCenter
                ...
                If .ShowDialog() <> DialogResult.OK Then
                    If FinanicialAccountsVariable.IsInserted = True Or FinanicialAccountsVariable.IsUpdated = True Then
                        If _Account.GetAccountData(_AccountNo) = True Then
                            ...
                            If _Account.IsActive = True Then
                                TreeList1.FocusedNode.SetValue(5, "True")
                            Else
                                TreeList1.FocusedNode.SetValue(5, "False")
                            End If
                            If _Account.NeedCostCenter = True Then
                                TreeList1.FocusedNode.SetValue(6, "True")
                            Else
                                TreeList1.FocusedNode.SetValue(6, "False")
                            End If
                            ...
                            'MsgBox(TreeList1.FocusedNode.GetValue(0))
                            'MsgBox(TreeList1.FocusedNode.GetValue(1))
                            'MsgBox(TreeList1.FocusedNode.GetValue(2))
                            'MsgBox(TreeList1.FocusedNode.GetValue(3))
                            'MsgBox(TreeList1.FocusedNode.GetValue(4))
                            'MsgBox(TreeList1.FocusedNode.GetValue(5))
                            'MsgBox(TreeList1.FocusedNode.GetValue(6))
