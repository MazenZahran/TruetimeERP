...
Public Class OrpakAdjustment
    ...
    Private Sub AdvBandedGridView1_PrintInitialize(sender As System.Object, e As DevExpress.XtraGrid.Views.Base.PrintInitializeEventArgs) _
        Handles GridViewMasterTickets.PrintInitialize, GridViewOrders.PrintInitialize, GridViewPayments.PrintInitialize
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleBtnSave.Click
        ...
        Dim sql As New SQLControl
        sql.SqlTrueAccountingRunQuery("  SELECT DISTINCT t1.MenuItemName, t1.Barcode,t2.ItemNo
                                         FROM [dbo].[SambaOrdersTemp] t1
                                         LEFT JOIN Items t2 ON t2.ItemNo  = t1.Barcode
    ...
    Private Function PostJournal() As Boolean
        ...
        Return _Return
    End Function
    Private Function IssueVoucher(_TicketID As Integer, Discount As Decimal)
        Try
            'Dim sql As 
